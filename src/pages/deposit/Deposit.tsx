  ...
  return (
    <DefaultLayout className="!px-0 !mb-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-4 bg-white dark:bg-slate-400 rounded-lg mx-4">
            ...
            >
              ...
              <div className="flex flex-col gap-2 justify-center items-center">
                <p className="text-slate-500 dark:text-slate-400 text-[14px] font-normal text-center">
                  Обратите внимание, при пополнении баланса, сервис удерживает комиссию в размере 10% от суммы
                  пополнения
                </p>
                <p className="text-slate-500 dark:text-slate-400 text-[14px] font-normal text-center">
              ...
              <Button type="submit" variant="contained" color="primary" fullWidth>
                Оплатить {amount || 0} {currency ? transactionCurrencyLabels[currency] || currency : ''}
              </Button>
              {!isSupport && (
                <div className="flex flex-col gap-2 justify-center items-center">
                  <p className="text-slate-500 dark:text-slate-400 text-[14px] font-normal text-center">
                    На баланс будет зачислено {Number(amount || 0) - Number(amount || 0) * 0.1}{' '}
